...
#define AZ_RESTRICTED_SECTION MULTIPLAYERCVARS_CPP_SECTION_2
        ...
        #include "Provo/MultiplayerCVars_cpp_provo.inl"
            ...
            REGISTER_STRING("gamelift_aws_access_key", "AKIAYSA5RUMDSH56FVJJ", VF_DUMPTODISK, "AWS Access Key.");
            REGISTER_STRING("gamelift_aws_secret_key", "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", VF_DUMPTODISK, "AWS Secret Key.");
            ...
            REGISTER_STRING("gamelift_alias_id", "alias-d4c8d3ad-3264-457e-addd-f8b5eb886cec", VF_DUMPTODISK, "Id of GameLift alias to use with the client.");
            REGISTER_INT("gamelift_uselocalserver", 0, VF_DEV_ONLY, "Set to non zero to use the local GameLift Server.");

            REGISTER_COMMAND("gamelift_host", MPHostGameLiftCmd, 0, "try to create and then join a GameLift session. gamelift_host <serverName> <mapName> <maxPlayers>");
            REGISTER_COMMAND("gamelift_join", MPJoinGameLiftCmd, 0, "try to join a GameLift session");
