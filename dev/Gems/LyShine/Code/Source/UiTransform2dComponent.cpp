...
AZ::Vector2 UiTransform2dComponent::GetViewportSpaceTopRight()
{
	RectPoints points;
...
AZ::Vector2 UiTransform2dComponent::GetViewportSpaceTopLeft()
{
	RectPoints points;
	GetViewportSpacePoints(points);
...
AZ::Vector2 UiTransform2dComponent::GetViewportSpaceBottomRight()
{
	RectPoints points;
	GetViewportSpacePoints(points);
...
AZ::Vector2 UiTransform2dComponent::GetViewportSpaceBottomLeft()
{
	RectPoints points;
	GetViewportSpacePoints(points);
...
void UiTransform2dComponent::Reflect(AZ::ReflectContext* context)
{
    ...
    if (behaviorContext)
    {
        behaviorContext->EBus<UiTransformBus>("UiTransformBus")
			...
			->Event("GetViewportSpaceTopRight", &UiTransformBus::Events::GetViewportSpaceTopRight)
			->Event("GetViewportSpaceTopLeft", &UiTransformBus::Events::GetViewportSpaceTopLeft)
			->Event("GetViewportSpaceBottomRight", &UiTransformBus::Events::GetViewportSpaceBottomRight)
			->Event("GetViewportSpaceBottomLeft", &UiTransformBus::Events::GetViewportSpaceBottomLeft)
