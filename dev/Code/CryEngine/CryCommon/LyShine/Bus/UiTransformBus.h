...
public: // member functions
	...
	virtual AZ::Vector2 GetViewportSpaceTopRight() = 0;
	virtual AZ::Vector2 GetViewportSpaceTopLeft() = 0;
	virtual AZ::Vector2 GetViewportSpaceBottomRight() = 0;
	virtual AZ::Vector2 GetViewportSpaceBottomLeft() = 0;
